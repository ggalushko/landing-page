  ...
  return (
    ...
    >
      ...
      <p className=" xs:text-xl text-shadowed md:w-5/6 xs:leading-8">
        ...
        and functional. We understand the importance of finding a prosthetic
        limb that fits your body and your lifestyle, which is why we offer a
        range of customizable options. From the size and shape of the limb to
        the level of functionality and control, our prosthetic limbs can be
        tailored to your unique needs. Join us in experiencing the future of
        prosthetics and take the first step towards transforming your life today
      </p>
